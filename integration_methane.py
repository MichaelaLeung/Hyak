...
if __name__ == '__main__':
    ...
    if platform.node().startswith("mox"):
        ...
        integration_metric(1.63,1.67,0)
        integration_metric(2.28, 2.32,0)
        integration_metric(3.28, 3.32,0)

        integration_metric(1.63,1.67,1)
        integration_metric(2.28, 2.32,1)
        integration_metric(3.28, 3.32,1)

        integration_metric(1.63,1.67,2)
        integration_metric(2.28, 2.32,2)
        integration_metric(3.28, 3.32,2)
    else:
