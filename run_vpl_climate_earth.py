...
# Run Plotting
plotlast = 1 # plot temperature, fluxes, heating rates
plotspec = 0 # plot ending climate model spectra
plotsteps = 200 # total number of timesteps in output file
stepper = 1 # number of steps to skip in output file between lines plotted
timefile = "output_runvpl_climate_timestep_2019-08-07.script.txt"
